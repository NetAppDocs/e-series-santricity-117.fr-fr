...
* Gestionnaire système SANtricity : interface web utilisée pour gérer un contrôleur d'une baie de stockage.
* SANtricity Unified Manager : interface web utilisée pour afficher et gérer toutes les baies de stockage de votre réseau.
