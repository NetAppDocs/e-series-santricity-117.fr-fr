...
[NOTE]
====
Vous pouvez également afficher cet état en sélectionnant l'icône SFP image:../media/sam1130-ss-hardware-sfp-icon.gif[""], En regard de la liste déroulante étagère.
