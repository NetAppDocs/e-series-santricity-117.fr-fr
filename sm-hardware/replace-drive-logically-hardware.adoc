...
[role="lead"]
En cas de panne d'un disque ou si vous souhaitez le remplacer pour une autre raison, vous pouvez remplacer le disque défectueux de manière logique par un disque non attribué ou un disque de secours entièrement intégré.
