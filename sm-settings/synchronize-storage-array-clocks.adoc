...
+
La boîte de dialogue Synchroniser les horloges de la matrice de stockage s'ouvre. Elle montre
la date et l'heure actuelles du ou des contrôleurs et de l'ordinateur utilisés comme
client de gestion.

+
[NOTE]
====
Pour les matrices de stockage simplex, un seul contrôleur
est illustré.
